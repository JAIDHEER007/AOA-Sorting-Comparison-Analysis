// Insertion Sort VS Quick Sort (Pure)
// Small
...
int main() {
    ...
    std::string resultsFile = "insertion_vs_quick_small.csv";
    ...
    for (const auto& testFile : testFiles) {
        ...
        results.emplace_back("quick_sort", power_of_2, testFile.first, avgQuickSortTime, quickSortStatus);
    }
