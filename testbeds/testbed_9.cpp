...
int main() {
    ...
    std::string resultsFile = "quicksort_insertion_radixsort_comparison_small.csv";
    ...
    for (const auto& testFile : testFiles) {
        ...
        results.emplace_back("quick_sort_hybrid", power_of_2, testFile.first, quickSort_avgTime, 1);
