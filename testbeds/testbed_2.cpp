// Insertion Sort VS Quick Sort (Random)
// Small
...
int main() {
    ...
    std::string resultsFile = "insertion_quick_random_small.csv";
    ...
    for (const auto& testFile : testFiles) {
        ...
        results.emplace_back("quick_sort_random", power_of_2, testFile.first, avgQuickSortTime, quickSortStatus);
    }
